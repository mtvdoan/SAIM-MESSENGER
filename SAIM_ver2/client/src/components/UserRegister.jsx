...
const UserRegister = () => {
 const {register, handleSubmit, formState: { errors } } = useForm();
  ...
  const screenNameString = JSON.stringify(localStorage.getItem(data["screenName"]) );
  console.log(screenNameString,data);
    navigate("/");
    alert(`Thanks for registering!, ${screenNameString}, ${data[screenNameString]}, ${data["screenName"]}`);
    //data["screenName"] works...
  };
  return (
    <>
                ...
                <form className="App" onSubmit={handleSubmit(onSubmit)}>
                  <label className="block">
                    ...
                    *Screen Name* is mandatory </span>}
                    ...
                    <input onChange="" name="screenName" id="screenName" type="text" placeholder="Screen Name" {...register("screenName", {required: true})} />
                  </label>         
                  <label className="block">
                    ...
                    *Email* is mandatory </span>}
                    ...
                    <input onChange="" name="email" id="email" type="email" placeholder="Email" {...register("email", { required: true })} />
                  </label>         
                  <label className="block">
                    ...
                    *Password* is mandatory </span>}
                    ...
                    <input name="password" type="text" id="password" placeholder="Password" {...register("password")} />
                  </label>
