...
import "../App.css";
import AwayMessagesList from "./AwayMessagesList";
const Chat = (props) => {
        ...
        <>
            ...
            <div className="grid grid-cols-2 content-center p-4">
                ...
                <div className="">
                    ...
                    >
                        <h2
                            className="text-xl h-12 font-extrabold dark:text-black bg-blue-500 border-black border-2"
                            style={{ width: "600px" }}
                        >
